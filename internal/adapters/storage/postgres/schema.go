...
var schemaStatements = []string{
	...
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS animal_type TEXT`,
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS sex TEXT`,
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS birth_date DATE`,
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS mother_animal_code TEXT`,
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS first_calving_date DATE`,
	`ALTER TABLE farm_animals ADD COLUMN IF NOT EXISTS notes TEXT`,
